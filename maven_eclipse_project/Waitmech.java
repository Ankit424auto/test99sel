...
public class Waitmech  extends BaseTest{
	@Test
...
public void testExplicitWait2() {
    ...
    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    boolean isTextMatching = wait.until(ExpectedConditions.textToBe(By.className("screen"), "11"));
    Assert.assertTrue(isTextMatching, "Expected the screen text to be '11'");
}
